...
class CentroSaludAgentExecutor(AgentExecutor):
    """An AgentExecutor that runs Centro de Salud ADK-based Agent."""
    ...
    def _run_agent(
        ...
        return self.runner.run_async(
            session_id=session_id, user_id="centro_salud_agent", new_message=new_message
        )
